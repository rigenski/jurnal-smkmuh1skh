...
Route::group(['middleware' => ['auth', 'checkRole:admin']], function () {
    ...
    Route::post('/admin/izin_guru/setting', 'IzinGuruController@setting')->name('admin.izin_guru.setting');
    ...
    Route::get('/admin/guru/format-export', 'GuruController@format_export');
    ...
    Route::get('/admin/karyawan/format-export', 'KaryawanController@format_export');
