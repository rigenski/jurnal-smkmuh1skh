                ...
                <div class="container px-4 max-w-2xl">
                    <div>
                        ...
                        <form class="p-4 w-full max-w-2xl bg-white rounded-lg shadow-lg md:p-8"
                            action="{{ route('jurnal.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <p class="mb-8 text-sm font-normal text-gray-600 lg:text-base">Semester
                                {{ date('n') <= 6 ? 'Genap' : 'Ganjil' }} <br /> Tahun
                            ...
                            <div class="w-full">
                                <div class="mb-2 flex flex-col md:mb-4">
                                    ...
                                    <select class="mt-2 border px-4 py-1.5 text-base font-normal text-gray-800 rounded-md"
                                        id="kelas" name="kelas">
                                        <option value="">-- Pilih --</option>
                                    </select>
                            ...
                            <div class="w-full">
                                <div class="mb-2 flex flex-col md:mb-4">
                                    ...
                                    <select class="border px-4 py-1.5 text-base font-normal text-gray-800 rounded-md"
                                        id="sampai_jam_ke" name="sampai_jam_ke" required>
                                        <option value="">-- Pilih --</option>
                                        <option>1</option>
                                        <option>2</option>
                                        <option>3</option>
                                    ...
                                    <small class="mt-2 text-xs font-normal text-gray-400">Pilih Jam yang sama jika hanya
                                        mengajar 1 Jam</small>
                                </div>
                            </div>
                            <div class="w-full">
                                <div class="mb-2 flex flex-col md:mb-4">
                            ...
                            <div class="w-full">
                                <div class="mb-2 flex flex-col md:mb-4">
                                    ...
                                    <small class="mt-2 text-xs font-normal text-gray-400">Contoh Penulisan : Siswa yang
                                        bernama Ahmad tidak masuk 3 kali berturut turut</small>
                                </div>
                            </div>
                            <div class="w-full">
                                <div class="mb-2 flex flex-col md:mb-4">
                                    <label class="mb-2 text-sm font-light text-gray-600" for="mengajar">
                                        8. Apakah Bapak dan Ibu mengajar di jam terakhir ? <span
                                            class="text-red-600">*</span>
                                    </label>
                                    <select class="border px-4 py-1.5 text-base font-normal text-gray-800 rounded-md"
                                        id="mengajar" name="mengajar" required>
                                        <option value="">-- Pilih --</option>
                                        <option>Ya</option>
                                        <option>Tidak</option>
                                    </select>
                                    ...
                                    <div class="mb-2 pb-2 flex w-full">
                                        ...
                                        <div class="w-full">
                                            <p class="mb-0.5 text-sm font-normal text-gray-600">Mata Pelajaran: <span
                                                    class="text-gray-800 font-bold">{{ $aktivitas->jurnal_guru->mata_pelajaran }}</span>
                                            </p>
                                            <div class="flex flex-wrap">
                                                <div class="w-full md:w-6/12">
                                                    <p class="mb-0.5 text-sm font-normal text-gray-600 ">Kelas: <span
                                                            class="text-gray-800 font-bold">{{ $aktivitas->jurnal_guru->kelas }}</span>
                                                    </p>
                                                </div>
                                                <div class="w-full md:w-6/12">
                                                    <p class="mb-0.5 text-sm font-normal text-gray-600 ">Jam: <span
                                                            class="text-gray-800 font-bold">{{ $aktivitas->jurnal_guru->jam_ke }}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                ...
                siswa.map((x) => {
                    elSiswa.innerHTML += `<div class="ml-4 py-0.5 flex justify-between border-t-2 border-b-2 border-gray-50">
                                            ...
                                            <select class="px-2 py-0.5 text-base font-normal text-gray-800" id="siswa[]" name="siswa[]">
                                                ...
                                                <option value='${x.id}-Bolos'>Bolos</option>
                                            </select>
                                        </div>`
                });
            }
                            ...
                            @if (count($aktivitas_jurnal_karyawan))
                                @foreach ($aktivitas_jurnal_karyawan as $aktivitas)
                                    <div class="mb-2 pb-2 flex w-full">
                                        ...
                                        <div class="w-full">
                                            <p class="mb-0.5 text-sm font-normal text-gray-600">Unit Kerja: <span
                                                    class="text-gray-800 font-bold">{{ $aktivitas->jurnal_karyawan->unit_kerja }}</span>
                                            </p>
                                            <p class="mb-0.5 text-sm font-normal text-gray-600">Deskripsi: <span
                                                    class="text-gray-800 font-bold">{{ $aktivitas->jurnal_karyawan->deskripsi }}</span>
                                            </p>
                                        </div>
                                    </div>
                                @endforeach
