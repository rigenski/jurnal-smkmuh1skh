                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#modalEdit" data-toggle="modal"
                                        onclick="$('#modalEdit #formEdit').attr('action', 'mata-pelajaran/{{ $data->id }}/update'); $('#modalEdit #formEdit #kode').attr('value', '{{ $data->kode }}'); $('#modalEdit #formEdit #nama').attr('value', '{{ $data->nama }}');"
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.mata_pelajaran.import') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="data_mata_pelajaran"
                                name="data_mata_pelajaran" accept=".xlsx, .xls">
                        ...
                        <a href="{{ route('admin.mata_pelajaran.format_export') }}" class="btn btn-warning mt-4">Unduh
                            Format
                            Import</a>
                </div>
                <div class="modal-footer">
