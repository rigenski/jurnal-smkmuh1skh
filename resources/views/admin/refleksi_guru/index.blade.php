            ...
            <div class="row w-100 mx-0">
                <div class="col-12 col-md-6 px-0">
                    <div class="d-flex justify-content-start align-items-center flex-wrap">
                        <form action="{{ route('admin.refleksi_guru') }}" method="get" class="d-flex">
                            <input type="month" class="form-control mr-2 mb-2" name="bulan" autocomplete="off"
                ...
                <div class="col-12 col-md-6 px-0">
                    <div class="d-flex justify-content-end align-items-center flex-wrap">
                        <div class="d-flex">
                            <a href="{{ route('admin.refleksi_guru') }}" class="btn btn-warning px-2 ml-2 mb-2">
                            ...
                            <button class="btn btn-success ml-2 mb-2" data-toggle="modal"
