@if ($request->tipe === 'Pendidik')
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td colspan="16">P5: Jika memiliki kesempatan mengajar materi pelajaran yang sama pada kelompok siswa
                    yang sama, hal apa yang akan dilakukan secara berbeda</td>
            </tr>
            <tr>
                <td colspan="16">P5: Jika memiliki kesempatan mengajar materi pelajaran yang sama pada kelompok siswa
                    yang sama, hal apa yang akan dilakukan secara berbeda</td>
            ...
            <tr>
                <td colspan="16">P7: Sebutkan nama siswa yang tampak membutuhkan lebih banyak dukungan dan perhatian
                    dibulan berikutnya</td>
            </tr>
        </tbody>
    </table>
@elseif($request->tipe === 'Wali Kelas')
    ...
    <table>
        <tbody>
            ...
            <tr>
                <td colspan="16">P1: Sebutkan nama siswa yang tampak membutuhkan lebih banyak dukungan dan perhatian
                    dibulan berikutnya</td>
            </tr>
            <tr>
