    ...
    <div class="card-header row">
        <div class="col-12 col-sm-6 p-0 my-1">
            <div class="d-flex align-items-start flex-column">
                <form action="/admin/jurnal" method="get" class="d-flex">
        ...
        <div class="col-12 col-sm-6 p-0 my-1">
            <div class="d-flex align-items-end flex-column">
                <div class="d-flex ">
                    <a href="{{ route('jurnal') }}" class="btn btn-warning px-2">
                    ...
                    <div class="mx-2">
                        <a href="{{ route('export') }}" class="btn btn-success">Export Semua</a>
                    </div>
                </div>
            </div>
        </div>
