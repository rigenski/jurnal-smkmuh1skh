                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#modalEdit" data-toggle="modal"
                                        onclick="$('#modalEdit #formEdit').attr('action', 'siswa/{{ $data->id }}/update'); $('#modalEdit #formEdit #username').attr('value', '{{ $data->user->username }}'); $('#modalEdit #formEdit #nis').attr('value', '{{ $data->nis }}'); $('#modalEdit #formEdit #nama').attr('value', '{{ $data->nama }}'); $('#modalEdit #formEdit #kelas').attr('value', '{{ $data->kelas }}');"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.siswa.import') }}" method="post" enctype="multipart/form-data">
                        ...
                        <a href="{{ route('admin.siswa.format_export') }}" class="btn btn-warning mt-4">Unduh
                            Format
                            Import</a>
                </div>
                <div class="modal-footer">
    ...
    <div class="modal fade" id="modalReset" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form id="formReset" action="{{ route('admin.siswa.reset') }}" method="get">
                        <button type="button" class="btn btn-secondary mr-2" data-dismiss="modal">Tidak</button>
