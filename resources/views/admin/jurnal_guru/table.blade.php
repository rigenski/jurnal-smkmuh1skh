    ...
    <tbody>
        ...
        <tr>
            @if($count <= 1)
                ...
                <td>{{ $siswa_pilihan->nama_siswa }} {{ $siswa_pilihan->status ? '(' . ($siswa_pilihan->status === 'Sakit' ? 'S' : ($siswa_pilihan->status === 'Izin' ? 'I' : ( $siswa_pilihan->status === 'Bolos' ? 'B' : 'A')) ) . ')' : ''  }}</td>
            ...
            @else
                ...
                <td></td>
                <td></td>
                <td>{{ $siswa_pilihan->nama_siswa }} {{ $siswa_pilihan->status ? '(' . ($siswa_pilihan->status === 'Sakit' ? 'S' : ($siswa_pilihan->status === 'Izin' ? 'I' : 'A') ) . ')' : ''  }}</td>
                <td></td>
                <td></td>
                <td></td>
            @endif
