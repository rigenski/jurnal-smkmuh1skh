...
@section('main')
    <div class="main-wrapper">
        ...
        <div class="main-sidebar">
            <aside id="sidebar-wrapper" style="margin-bottom: 200px;">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="@yield('refleksi_siswa')"><a class="nav-link" href="{{ route('admin.refleksi_siswa') }}">
                            <i class="fas fa-bookmark"></i>
                            <span>Refleksi Siswa</span></a></li>
                    <li class="@yield('sertifikat')"><a class="nav-link" href="{{ route('admin.sertifikat') }}"><i
                                class="fas fa-book"></i>
                    ...
                    <li class="@yield('guru_mata_pelajaran')"><a class="nav-link" href="{{ route('admin.guru_mata_pelajaran') }}"><i
                                class="fas fa-book"></i>
