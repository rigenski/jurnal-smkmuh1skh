...
@section('main')
    ...
    <main class="-mt-[60px] md:-mt-[64px]">
        @if(session('success'))
        <div class="w-full h-80 bg-gradient-to-br from-emerald-500 to-emerald-700"></div>
        @else
        <div class="w-full h-80 bg-gradient-to-br from-rose-500 to-rose-700"></div>
        @endif
                ...
                <div>
                    ...
                    <div class="p-4 w-full max-w-2xl bg-white rounded-lg shadow-lg md:p-8" >
                        ...
                        <div class="py-8 flex flex-col justify-center items-center">
                            <div class="mb-4">
                                <iframe src="https://lottie.host/?file=85bc158d-6c8c-491a-89d3-d5e767183c04/qb5d3sewMv.json"></iframe>
                            </div>
                        ...
                        <div class="py-8 flex flex-col justify-center items-center">
                            <div class="mb-4">
                                <iframe src="https://lottie.host/?file=ef2bec90-d792-4493-b64c-3ed91052c3f5/LMu94CrL61.json"></iframe>
                            </div>
