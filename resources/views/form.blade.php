        ...
        <div class="card-body p-3 p-sm-5">
            ...
            <form action="{{ route('create')}}" method="post" id="izin" enctype="multipart/form-data">
                ...
                <div class="form-group my-4">
                    ...
                    <small class="form-text text-muted mt-2">Ukuran maksimal 5Mb</small>
                ...
                <div class="modal-body">
                    <div class="activities">
                        ...
                        <div class="activity align-items-center mb-2">
                            ...
                            <div class="activity-detail w-100 m-0">
                                <div class="mb-1">
                                    <span class="text-job text-warning">{{ $data->izin_guru->tanggal }}</span>
                                    <div class="float-right dropdown">
                                        <span class="font-weight-bold text-warning">{{ $data->izin_guru->kelas }}
                                            {{ $data->izin_guru->kompetensi_keahlian }}</span>
                                    </div>
                                </div>
                                <p>Mapel: <span class="font-weight-bold text-warning text-medium">{{
                                        $data->izin_guru->mata_pelajaran }}</span>
                                    -
                                    Jam Ke: <span class="font-weight-bold text-warning">{{ $data->izin_guru->jam_ke
                                        }}</span>
                                </p>
                            </div>
                        </div>
...
<div class="container my-0 my-sm-5 px-0 px-sm-2">
    ...
    <div class="modal fade" id="modalHistori" data-backdrop="static" data-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Histori Jurnal minggu ini</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
