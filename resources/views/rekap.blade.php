        ...
        <div class="-mt-[400px] pb-24 flex justify-center md:-mt-[360px]">
            <div class="container px-4 max-w-2xl">
                <div>
                    ...
                    <form class="p-4 w-full max-w-2xl bg-white rounded-lg shadow-lg md:p-8" action="{{ route('rekap') }}"
                        method="get">
                        <h4 class="mb-4 text-2xl font-semibold text-gray-800 lg:text-3xl">Rekap Data</h4>
                        <div class="mb-8">
                            ...
                            <div class="flex justify-between">
                                ...
                                @if ($request->search1 !== null || $request->search2 !== null)
                                    <a href="{{ route('rekap.export') }}"
                                        class="ml-2 flex justify-center max-w-[140px] w-full bg-indigo-600 px-2 py-2 text-base font-bold text-white rounded">
                                        UNDUH
                                    </a>
                                @endif
                            </div>
