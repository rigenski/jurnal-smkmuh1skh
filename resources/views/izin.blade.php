                ...
                <div class="container px-4 max-w-2xl">
                    <div>
                        ...
                        <form class="p-4 w-full max-w-2xl bg-white rounded-lg shadow-lg md:p-8"
                            action="{{ route('izin.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="w-full">
                                <div class="mb-2 flex flex-col md:mb-4">
                                    ...
                                    <input type="text"
                                        ...
                                        id="petunjuk_tugas" name="petunjuk_tugas" />
                                    <input type="file"
                                        class="border px-4 py-1.5 text-base font-normal text-gray-800 rounded-md"
                            ...
                            @if (count($aktivitas_izin_guru))
                                @foreach ($aktivitas_izin_guru as $aktivitas)
                                    <div class="mb-2 pb-2 flex w-full">
                                        ...
                                        <div class="w-full">
                                            <p class="mb-0.5 text-sm font-normal text-gray-600">Jenis Izin: <span
                                                    class="text-gray-800 font-bold">{{ $aktivitas->izin_guru->jenis_izin }}</span>
                                            </p>
                                            <div class="flex flex-wrap">
                                                <div class="w-full md:w-6/12">
                                                    <p class="mb-0.5 text-sm font-normal text-gray-600 ">Kelas: <span
                                                            class="text-gray-800 font-bold">{{ $aktivitas->izin_guru->kelas }}</span>
                                                    </p>
                                                </div>
                                                <div class="w-full md:w-6/12">
                                                    <p class="mb-0.5 text-sm font-normal text-gray-600 ">Jam: <span
                                                            class="text-gray-800 font-bold">{{ $aktivitas->izin_guru->jam_ke }}</span>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
